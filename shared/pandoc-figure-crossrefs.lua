-- Adapted from pi-markdown-preview's MIT-licensed filter (commit 142739a).
...
function Pandoc(document)
  ...
  for identifier, figure in pairs(figures) do
    if figure.count > 1 or identifier_counts[identifier] ~= 1 then
      io.stderr:write("pandoc-glance: duplicate figure identifier: ", identifier, "\n")
    end
  end
  ...
  for identifier in pairs(unresolved) do
    io.stderr:write("pandoc-glance: unresolved figure reference: ", identifier, "\n")
  end
  return result
end
